...
import com.example.vknewsclient.UseToken
...
private val TAG = "ScreenWithVKIDButton"
...
public fun onVKIDAuthFail(
    ...
    when (fail) {
        is VKIDAuthFail.Canceled -> {
            Log.d(TAG, "onVKIDAuthFail: fail: ${fail.description}")
            Log.d(TAG, "onVKIDAuthFail: oAuth: $oAuth")
